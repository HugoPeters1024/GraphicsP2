...
namespace template
{
    class RayTracer
    {
        ...
        public RayTracer()
        {
            ...
            scene.AddLight(new SpotLight(new Vector3(3.5f, 0f, camera.Position.Z), new Vector3(0, 0, 0), 0.5f));
            scene.AddLight(new SpotLight(new Vector3(-3.5f, 0f, camera.Position.Z), new Vector3(0, 0, 0), 0.5f));
            //scene.AddLight(new SpotLight(new Vector3(camera.Position), new Vector3(0, 0, 1), 1f));
